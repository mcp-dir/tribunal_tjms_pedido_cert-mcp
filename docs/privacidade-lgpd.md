...
Tribunal TJMS: Cadastro de Pedido de Certidão (1º grau) segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [tribunal_tjms_pedido_cert@mcp.ai](mailto:tribunal_tjms_pedido_cert@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
